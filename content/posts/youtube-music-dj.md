---
title: "YouTube Musicの再生履歴をAIに渡したら、プレイリスト作りが変わった"
date: "2026年3月20日"
description: "Google TakeoutでYouTube Musicの再生履歴を取り出し、AIに渡してみた。「チルい曲で」「深夜ドライブ用に50曲」という雑なリクエストでも、自分好みのプレイリストが返ってきた体験記。"
category: "C"
---
...
![AIが返した音楽の好み分析結果](/posts/ymd-analysis-result.png)
...
![AIが出力したチル系ミックスのプレイリスト](/posts/ymd-chill-playlist.png)

---

## 良かった点・いまいちだった点

やってみて感じたのは、**「自分のデータを渡す」という一手間が、精度に大きく効いている**ということ。
...
- AI が提案した曲が YouTube Music に登録されていないことがたまにある
...
精度をさらに上げたいなら、最初に「この曲が好き」「このアーティストの雰囲気で」と具体例を添えると良い。「○○みたいな雰囲気で、まだ聴いたことない曲も多めに」と注文をつければ、新しい発見も増える。
